...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar( array(
			'name'          => __( 'Right Sidebar', 'plaintheme' ),
			'id'            => 'right-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Left Sidebar', 'plaintheme' ),
			'id'            => 'left-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Slider', 'plaintheme' ),
			'id'            => 'hero',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Static', 'plaintheme' ),
			'id'            => 'statichero',
		...
		register_sidebar( array(
			'name'          => __( 'Footer Full', 'plaintheme' ),
			'id'            => 'footerfull',
